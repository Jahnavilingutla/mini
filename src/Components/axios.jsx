...
const Get = () => {
  ...
  return (
    ...
    <div>
      ...
      <div class="row row-cols-1 row-cols-md-3 g-3" style={{marginLeft:"40px"}}>
      {data.map((x, index) => (
  <div class="col">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <h5 class="card-title" style={{textAlign:"center",color:"orange",marginLeft:"20px"}}>Recruitment & Talent Acquisiton</h5>
   ...
   <div class="col">
      ...
      <div class="card-body">
        <h5 class="card-title" style={{textAlign:"center",color:"orange",marginLeft:"20px"}}>How Can We Help?</h5>
    ...
    <div class="card">
   <div class="col">
      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-rF-AlgK8-rMCeUE00A4cR7jeOM7HaPy13w&usqp=CAU" class="card-img-top" alt="..." height={200} style={{border:"10px solid white"}} />
      <div class="card-body">
        <h5 class="card-title" style={{textAlign:"center",color:"orange",marginLeft:"20px"}}>How Can We Help?</h5>
        <p class="card-text">Finding a Medicare plan that fits your needs is a breeze with the right help. Our licensed agents can help answer all your questions hence they will solve all your queries.</p>
        <center><img src="https://cdn.pixabay.com/photo/2012/04/23/15/47/arrow-38632_960_720.png" height={30} width={30}/></center>
